...
function releaseNotes(_config, args = {}) {
  ...
  return {
    ...
    commitMessage: "feat: add v10 release readiness and connector validation tools",
    tagMessage: `Rel.AI MCP v${version}: release readiness, connector verification, and workspace preflight`,
    bullets: [
      "Adds release-readiness scoring for config, approval gates, command availability, state directories, and workspace setup.",
      "Adds connector verification helpers for ChatGPT Developer Mode endpoint/token setup.",
