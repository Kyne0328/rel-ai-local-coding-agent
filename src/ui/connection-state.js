...
const LAYERS = Object.freeze([
  ...
  ['dashboardUpdates', 'Dashboard updates', { live: ['Live','ok','This dashboard is receiving live local state updates.'], connecting: ['Connecting','working','The dashboard is connecting live updates.'], reconnecting: ['Reconnecting','working','The dashboard is restoring live updates.'], paused: ['Paused','warn','Live dashboard updates are paused.'], offline: ['Offline','bad','This dashboard is not receiving live updates.'] }]
]);
