const ICONS = Object.freeze({
  ...
  learning: '<path d="M8 4a4 4 0 0 0-4 4v8a4 4 0 0 0 4 4h8a4 4 0 0 0 4-4V8a4 4 0 0 0-4-4H8Z"/><path d="M8 9h8M8 13h6M8 17h4"/>',
...
export const APPLICATION_NAV_ITEMS = Object.freeze([
  ...
  route('settings', 'Settings', 'settings', 'Change connection, preferences, learning, and app settings.', 'Application')
]);
...
export const SETTINGS_NAV_ITEMS = Object.freeze([
  ...
  route('learning', 'Learning', 'settings/learning', 'Manage reusable skills ChatGPT explicitly saves through Rel.AI.', 'Settings'),
