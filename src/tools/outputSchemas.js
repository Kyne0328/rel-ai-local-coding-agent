...
const TOOL_FIELDS = Object.freeze({
  ...
  [OP.SEARCH_SEMANTIC]: ['ok', 'workspace', 'work_id', 'query', 'queries', 'queryCount', 'uniqueFileCount', 'execution', 'strategy', 'privacy', 'fingerprint', 'cacheHit', 'neuralEmbeddings', 'results', 'resultCount', 'matchCount', 'returnedBytes', 'truncated', 'next'],
