...
const TOOL_FIELDS = Object.freeze({
  ...
  relai_exec: ['ok', 'executed', 'commandSucceeded', 'workspace', 'work_id', 'command', 'commandSummary', 'cwd', 'shell', 'durationMs', 'exitCode', 'stdout', 'stderr', 'stdoutBytes', 'stderrBytes', 'stdoutTruncated', 'stderrTruncated', 'timedOut', 'cancelled', 'terminationConfirmed', 'forcedTermination', 'signal', 'error', 'environmentKeys', 'changedFiles', 'changedFilesTruncated', 'mutationTracking'],
  ...
  relai_semantic_search: ['ok', 'workspace', 'work_id', 'query', 'queries', 'queryCount', 'uniqueFileCount', 'execution', 'strategy', 'privacy', 'fingerprint', 'cacheHit', 'neuralEmbeddings', 'results', 'resultCount', 'matchCount', 'returnedBytes', 'truncated', 'next'],
  relai_diagnostics_run: ['ok', 'workspace', 'work_id', 'commands', 'results', 'diagnostics', 'diagnosticCount', 'completedUnits', 'totalUnits', 'execution', 'cancelled', 'truncated', 'message'],
...
const SUCCESS_REQUIRED_FIELDS = Object.freeze({
  relai_exec: ['workspace', 'work_id', 'executed', 'commandSucceeded', 'exitCode', 'durationMs'],
