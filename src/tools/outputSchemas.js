...
const TOOL_FIELDS = Object.freeze({
  ...
  relai_semantic_search: ['ok', 'workspace', 'work_id', 'query', 'queries', 'queryCount', 'uniqueFileCount', 'strategy', 'privacy', 'fingerprint', 'cacheHit', 'neuralEmbeddings', 'results', 'resultCount', 'matchCount', 'returnedBytes', 'truncated', 'next'],
