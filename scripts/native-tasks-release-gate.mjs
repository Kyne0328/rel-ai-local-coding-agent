...
const RELEASE_GATE_CHECKS = Object.freeze([
  ...
  check('http_matrix', 'HTTP capability matrix and native/fallback lifecycle', 'test/native-tasks-http.mjs'),
  check('http_parity', 'HTTP parity, authentication, authorization, and cancellation', 'test/native-tasks-transport-http.mjs'),
  check('stdio_matrix', 'stdio capability matrix, parity, isolation, cancellation, and abort', 'test/native-tasks-stdio-integration.mjs'),
