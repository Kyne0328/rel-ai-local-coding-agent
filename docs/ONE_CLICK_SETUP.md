...
```text
Use Rel.AI MCP on workspace myapp. Start a task, retain its work_id, then show the workspace profile and the first 100 tree entries using that work_id. Do not modify files.
```
