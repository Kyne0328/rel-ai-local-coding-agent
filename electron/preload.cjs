...
if (surface === 'dashboard') {
  contextBridge.exposeInMainWorld('relaiDesktop', {
    ...
    createCloudPairingCode: () => ipcRenderer.invoke('desktop:cloud:create-pairing-code'),
    reconnectCloudRelay: () => ipcRenderer.invoke('desktop:cloud:reconnect'),
    resetCloudRelay: () => ipcRenderer.invoke('desktop:cloud:reset'),
