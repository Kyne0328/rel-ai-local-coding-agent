...
assert.match(home, /desktopRuntimeCard/);
assert.match(home, /Publishing the ChatGPT endpoint/);
assert.match(home, /data-desktop-settings/);
assert.match(home, /data-desktop-restart/);
assert.match(home, /data-desktop-recovery/);
