...
assert.match(statusHtml, /OpenAI Secure MCP Tunnel/);
...
assert.match(statusJs, /OpenAI Secure MCP Tunnel did not become ready/);
...
assert.match(desktopConnection, /saved key is encrypted locally and is never returned/i);
