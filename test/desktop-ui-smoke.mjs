...
assert.match(wizardHtml, /Step 1 of 3/);
assert.match(wizardHtml, /Step 2 of 3/);
assert.match(wizardHtml, /Step 3 of 3/);
assert.doesNotMatch(wizardHtml, /id="step[45]"/);
assert.match(wizardHtml, /id="toggleNgrokTokenBtn"/);
assert.match(wizardHtml, /id="reviewSetupBtn"/);
assert.match(wizardJs, /const STEP_COUNT = 3/);
...
const desktopNotifications = read('src/ui/features/settings/desktop-notifications.js');
...
assert.doesNotMatch(statusJs, /showDesktopNotification/);
assert.match(statusJs, /syncNotificationPreference/);
assert.match(statusJs, /function toggleNotifications\(\)[\s\S]*runAsync\(syncNotificationPreference\(\)\)/);
...
assert.match(electronMain, /openDashboardWindow\('#diagnostics'\)/);
assert.doesNotMatch(electronMain, /settings\.html|options\.edit/);
assert.match(electronMain, /createDesktopNotifications/);
assert.match(electronMain, /handleDesktopStatusChange/);
assert.match(electronMain, /handleUpdateStatus/);
assert.match(electronMain, /if \(!options\.silent\) desktopNotifications\.handleDesktopStatusChange\(previousStatus, currentStatus\)/);
...
assert.match(generalSettings, /getNotificationPreferences/);
assert.match(generalSettings, /desktopNotificationsPanel\(notifications\?\.preferences\)\.el/);
const applicationSettings = read('src/ui/features/settings/application.js');
assert.match(applicationSettings, /desktopStartupPanel\(lifecycle\)\.el/);
assert.match(applicationSettings, /applicationUpdatesPanel\(\)\.el/);
assert.match(desktopNotifications, /Task completed/);
assert.match(desktopNotifications, /Errors and failed operations/);
assert.match(desktopNotifications, /Connection and service status/);
assert.match(desktopNotifications, /Application updates/);
assert.match(desktopNotifications, /Notify me about/);
...
assert.match(dashboardPreload, /desktop:notification-preferences:get/);
assert.match(dashboardPreload, /desktop:notification-preferences:set/);
...
assert.match(ipcHandlers, /desktop:notification-preferences:get/);
assert.match(ipcHandlers, /desktop:notification-preferences:set/);
