...
assert.match(html, /Connect Rel\.AI to ChatGPT/);
...
assert.match(html, /Support project on GitHub/);
...
assert.match(ipc, /https:\/\/github\.com\/Kyne0328\/rel-ai-mcp/);
...
assert.match(main, /showDashboardWindow\(options\.firstRun \? '#connection' : ''\)/, 'Successful first-run setup must hand off directly to the remaining ChatGPT Connection setup.');
