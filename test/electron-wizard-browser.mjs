...
assert.ok(html.indexOf('data-open-openai="apiKeys"') < html.indexOf('id="tunnelApiKeyInput"'), 'Runtime-key source action must immediately precede its destination field.');
