...
assert.match(main, /showDashboardWindow\(options\.firstRun \? '#settings\/connection' : ''\)/, 'Successful first-run setup must hand off directly to the remaining ChatGPT Connection setup.');
